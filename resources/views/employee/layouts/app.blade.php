    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
            ...
            --header-h: 64px;
            --primary:   #1A1A2E;
            --accent:    #2563EB; /* Blue accent for employee */
            --accent-red:#E63946; /* Red for alert/overdue */
            --accent2:   #F4A261;
            --surface:   #16213E;
            --surface2:  #0F3460;
            --text:      #E8ECEF;
        ...
        .icon-btn:hover { background: #fff; border-color: var(--accent); color: var(--accent); }
        ...
        main.employee-main::-webkit-scrollbar { width: 5px; }
        main.employee-main::-webkit-scrollbar-thumb { background: rgba(0,0,0,.1); border-radius: 99px; }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <span class="nav-section s-label" style="margin-top:4px">Công việc</span>
        <a href="{{ route('employee.dashboard') }}#cong-viec" class="nav-item">
            <i data-lucide="clipboard-list" style="width:17px;height:17px"></i>
            <span class="s-label">Công việc của tôi</span>
        </a>
    ...
    <div class="sidebar-footer">
        <div class="user-card">
            <div class="user-avatar-sm">{{ substr(Auth::user()->name ?? 'NV', 0, 2) }}</div>
            <div class="s-user-info">
                <div class="s-name">{{ Auth::user()->name ?? 'Nhân viên' }}</div>
                <div class="s-role">Nhân viên</div>
            </div>
        </div>
...
<div class="app-body">
    ...
    <header class="topbar">
        ...
        <h1 class="topbar-title">@yield('page_title', 'Dashboard Nhân viên')</h1>
